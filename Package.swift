...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "ZingCoachSDK",
            url: "https://github.com/Muze-Fitness/zing-coach-sdk-ios/releases/download/1.0.3/ZingCoachSDK.xcframework.zip",
            checksum: "719738f776e078891e782b39cec179be0ddaca8cdba6d7ebc68b061a4d79446b"
        ),
        .target(
            name: "ZingCoach",
            dependencies: [
